  ...
  return (
    <div className='bg1 flex justify-evenly p-2 fixed top-0 left-0 right-0 z-[9999]'>
        ...
        <div className='hidden lg:flex gap-4 items-center text-gray-200 font-semibold'>
            <NavLink to="/intheater" end onClick={() => scrollToSection("intheater")}>In Theater</NavLink>
            <NavLink to="/blockbuster" onClick={() => scrollToSection("blockbuster")}>Blockbusters</NavLink>
            <NavLink to="/favorite" onClick={() => scrollToSection("favorite")}>Favorite</NavLink>
        </div>
        ...
        <motion.div 
            ...
            <NavLink to="/intheater" onClick={() => {setMenu(!menu); scrollToSection("intheater")}} className='bg-zinc-600 rounded-lg p-2 mt-3 w-full' end>Now Playing</NavLink>
